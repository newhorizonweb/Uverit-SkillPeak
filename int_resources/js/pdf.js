...
function pdfPageDimensions() {
    ...
    const sizeRatio = `1/${(parseFloat(docHeight) / parseFloat(docWidth)).toFixed(5).toString()}`;
...
const photoBorderColor = document.querySelector(".photo-border-color-input");
/* Size */
...
const secSnap = document.querySelector(".add-section-snap");
const addSmallTxt = document.querySelector(".add-section-txt-size");
/* Section Snap */
