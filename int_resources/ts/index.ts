...
const cvBtn:HTMLElement | null = document.querySelector(".lp-btn");
...
document.addEventListener("DOMContentLoaded", function(){
    ...
    const navMark:HTMLElement | null = document.querySelector(".nav-mark");
    const settingsBtn:HTMLElement | null = document.querySelector(".settings-btn");
    ...
    navElements.forEach((navElem) => {
        navElem.addEventListener("click", function(){
            ...
            const navLink:string | null = navElem.getAttribute("data-link");
    ...
    settingsBtn?.addEventListener("click", function(){
        ...
        settingsBtn.classList.add("open-settings");

        // Remove the current nav element class
        navElements.forEach((navElem) => {
            navElem.classList.remove("curr-section");
            setTimeout(() =>{
                navElem.classList.remove("curr-pos");
        ...
        // Disappear the nav mark
        navMark?.classList.add("mark-invisible");

        // Fade in the settings section
        sections.forEach((section) => {
    ...
    const expandPdfBtn:HTMLElement | null = document.querySelector(".expand-pdf-btn");
    const closePdfBtn:HTMLElement | null = document.querySelector(".close-pdf-btn");
