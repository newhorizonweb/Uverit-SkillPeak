...
const infoFields:NodeListOf<Element> = document.querySelectorAll(".info-field-section");
const addInfoName:HTMLInputElement | null = document.querySelector(".sec-add-sec-name");
...
infoFields.forEach(function(infoField){
    ...
    const infoFieldInput:HTMLElement | null = infoField!.querySelector(".sec-info-field");
    const infoFieldBtnsDiv:HTMLInputElement | null = infoField!.querySelector(".list-desc-btns");
    ...
    const maxSumDescLength:number = 1000; 
...
function addLink(){
    ...
    if (linkNumber < 6){
        ...
        const pdfOutput:HTMLElement = document.createElement("a");
        ...
        newInput2.addEventListener("input", function(){
            let linkHref:string = newInput2.value;
...
function addExperience(){
    ...
    if (listNumber < 10){
        ...
        const maxDescLength:number = 800; 
...
function addLang(){
    ...
    if (langNumber < 8){
        ...
        const outputShort:HTMLElement | null | undefined = output?.querySelector(".pdf-lang-lvl-short");
        const outputLong:HTMLElement | null | undefined = output?.querySelector(".pdf-lang-lvl-long");
        const outputSpans:NodeListOf<Element> | undefined = output?.querySelectorAll(".lang-lvl-span");
